...
const ReportDashboard: React.FC<ReportDashboardProps> = ({ userId, lang }) => {
    ...
    const handleSendReport = async () => {
        ...
        try {
            ...
            const msg = sendError?.response?.data?.details || 'Failed to send. Please try again.';
            toast.error(msg);
        } finally {
                    ...
                    <div className="send-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="send-modal-field">
                            ...
                            <textarea
                                ...
                                placeholder="Add anything you want your therapist to know before the session."
                            />
                        </div>
                        <div className="send-modal-preview">
                            <p className="send-preview-subject">Subject: {subject}</p>
                            <pre>{body}</pre>
                        </div>
